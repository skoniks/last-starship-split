...
2. Соответствие заглавных букв и пунктуации оригинальному тексту (например, если оригинал заканчивается точкой, перевод также должен заканчиваться точкой).
3. Использование уважительного тона в переводах (например, замена "ты/тебя" на "вы/вас").
4. Обеспечение читаемости и ясности переводов, но не добавляйте спецсимволы вроде "Ё".
5. Исправление ошибок или несоответствий в переводах.
...
- Менять только перевод, не удалять строки, переносы и что либо кроме перевода.
